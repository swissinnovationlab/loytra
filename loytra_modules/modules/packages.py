...
repo_udisks2 = PackagerRepo("repo_udisks2", "extra/udisks2", "udisks2", "udisks2")
repo_imagemagick = PackagerRepo("repo_imagemagick", "extra/imagemagick", "imagemagick", "imagemagick")
repo_lshw = PackagerRepo("repo_lshw", "community/lshw", "lshw", "lshw")
python_opencv = MultiPackager("python_opencv", [PackagerRepo("repo_python_opencv", "extra/python-opencv", "python-opencv", "py3-opencv"), PackagerPip("pip_python_opencv", package='opencv-python', module='cv2')])
...
python_bleak = PackagerPip("python_bleak", "bleak", "bleak")
python_pillow = PackagerPip("python_pillow", "pillow", "PIL")
python_numpy = PackagerPip("python_numpy", "numpy", "numpy")
